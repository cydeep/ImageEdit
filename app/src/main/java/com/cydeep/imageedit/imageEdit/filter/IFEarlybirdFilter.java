...
public class IFEarlybirdFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.image_filter_earlybird_curves);
        addInputTexture(R.drawable.image_filter_earlybird_overlay_map);
        addInputTexture(R.drawable.image_filter_vignette_map);
        addInputTexture(R.drawable.image_filter_earlybird_blowout);
        addInputTexture(R.drawable.image_filter_earlybird_map);
    }
}
