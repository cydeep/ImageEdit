...
public class IFHefeFilter extends IFImageFilter {
    ...
    private void setRes() {
        addInputTexture(R.drawable.image_filter_edge_burn);
        addInputTexture(R.drawable.image_filter_hefe_map);
        addInputTexture(R.drawable.image_filter_hefe_gradient_map);
        addInputTexture(R.drawable.image_filter_hefe_soft_light);
        addInputTexture(R.drawable.image_filter_hefe_metal);
    }
}
