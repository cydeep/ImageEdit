...
public class IFSutroFilter extends IFImageFilter {
    ...
    private void setRes() {
        ...
        addInputTexture(R.drawable.image_filter_sutro_metal);
        addInputTexture(R.drawable.image_filter_soft_light);
        addInputTexture(R.drawable.image_filter_sutro_edge_burn);
        addInputTexture(R.drawable.image_filter_sutro_curves);
    }
}
